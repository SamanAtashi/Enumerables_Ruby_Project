...
describe Enumerable do
  ...
  describe '#my_select' do
    it 'returns new array of elements in an array that meet a certain criteria' do
      expect(int_arr.my_select(&:even?)).to eql([2, 4])
      expect(int_arr.my_select(&:odd?)).to eql([1, 3, 5])
    end
    it 'returns new array of elements in an array that meet a certain criteria' do
      expect(combined_arr.my_select(&:nil?)).to eql([nil])
  ...
  describe '#my_count' do
    it 'returns the number of items in an array' do
      ...
      expect(int_arr.my_count(&:even?)).to eql(2)
    end
    it 'returns the number of items in an array' do
